...
const uint16_t PROGMEM rshort_combo[] = {KC_M, KC_K, COMBO_END};
...
combo_t key_combos[] = {
 ...
 COMBO(laltl_combo, OSM(MOD_LALT)),
 COMBO(lctrl_combo, OSM(MOD_LCTL)),
 COMBO(lgui_combo, OSM(MOD_LGUI)),
 COMBO(lshift_combo, OSM(MOD_LSFT)),

 COMBO(del_combo, KC_DEL),
 COMBO(mply_combo, KC_MPLY),
 COMBO(raltl_combo, OSM(MOD_RALT)),
 COMBO(tab_combo, KC_TAB),

 COMBO(laltr_combo, OSM(MOD_LALT)),
 COMBO(rctrl_combo, OSM(MOD_RCTL)),
 COMBO(rgui_combo, OSM(MOD_RGUI)),
 COMBO(rshift_combo, OSM(MOD_RSFT)),

 COMBO(rshort_combo, OSL(_R_SHORT)),
 COMBO(ent_combo, KC_ENT),
 COMBO(micmute_combo, KC_F20),
 COMBO(raltr_combo, OSM(MOD_RALT)),
 COMBO(nav_combo, OSL(_NAV)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_NAV] = LAYOUT(
   ...
   _______, KC_HOME, KC_PGUP, KC_END,  _______,             _______, KC_DOWN, CTL_PUP, CTL_PDN, _______,
