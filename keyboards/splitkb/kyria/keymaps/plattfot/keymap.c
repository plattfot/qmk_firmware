 ...
 */
    [_R_SHORT] = LAYOUT(
      XXXXXXX, _______, _______, _______, C(KC_UP),_______,                                     _______, G(KC_7), G(KC_8), G(KC_9), _______, XXXXXXX,
      XXXXXXX, _______, _______, _______, _______, _______,                                  A(C(KC_M)), G(KC_1), G(KC_2), G(KC_3), G(KC_0), XXXXXXX,
