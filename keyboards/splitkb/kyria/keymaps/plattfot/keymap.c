 ...
 */
    [_BASE] = LAYOUT(
      OS_RALT, KC_Q,   KC_W,   KC_F,   KC_P,   KC_B,                                         KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, OS_RALT,
 ...
 */
    ...
    [_R_SYMFU] = LAYOUT(
      ...
      _______, EU_DEG,  _______, KC_LPRN, KC_RPRN, EU_CDOT, XXXXXXX, TO_BASE, TO_BASE, XXXXXXX, _______, KC_4,    KC_5,   KC_6,   KC_DOT,  _______,
