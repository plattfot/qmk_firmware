 ...
 */
    [_L_SYMFU] = LAYOUT(
      ...
      XXXXXXX, _______, KC_F6,   KC_F5,   KC_F4,   CLO_TAP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LT,   KC_GT,   KC_DQUO, KC_TILDE,KC_QUES, XXXXXXX,
                                 _______, XXXXXXX, _______, _______, _______, _______, KC_DEL,  _______, XXXXXXX, _______
 ...
 */
    [_R_SHORT] = LAYOUT(
      XXXXXXX, _______, _______, _______, _______, _______,                                     _______, G(KC_7), G(KC_8), G(KC_9), _______, XXXXXXX,
      XXXXXXX, _______, _______, _______, _______, _______,                                     _______, G(KC_1), G(KC_2), G(KC_3), G(KC_0), XXXXXXX,
