 ...
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * |  Nav   |   Z  |   X  |   C  |   D  |   V  |      |      |  |      |      |   K  |   H  |   ,  |   .  |   /  |  Nav   |
 * `----------------------+------+------+------| Space| Tab  |  |  BS  | Enter|------+------+------+----------------------'
 *                        | MPlay| LGui | LSYMF|      |      |  |      |      | RSYMF| RGui | MMute|
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `-----------------------Esc--------'  `--------Esc-----------------------'
 */
 [_BASE] = LAYOUT(
      ...
      OSL_NAV, KC_Z,   KC_X,   KC_C,   KC_D,   KC_V,    XXXXXXX,  XXXXXXX, XXXXXXX, XXXXXXX, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, OSL_NAV,
                               KC_MPLY,KC_LGUI,L_SYMFU, KC_SPACE, KC_TAB,  KC_BSPC,  KC_ENT, R_SYMFU, KC_LGUI, KC_F20
    ),
 ...
 */
    [_L_SYMFU] = LAYOUT(
      ...
      _______, KC_F11,  KC_F3,   KC_F2,   KC_F1,   _______,                                     KC_LCBR, KC_RCBR, KC_QUOT, KC_COLN, KC_CIRC, _______,
      _______, KC_F10,  KC_F6,   KC_F5,   KC_F4,   CLO_TAP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LT,   KC_GT,   KC_DQUO, KC_TILDE,KC_QUES, _______,
 ...
 */
    ...
    [_R_SYMFU] = LAYOUT(
      ...
      _______, KC_EXLM, KC_BSLS, KC_PLUS, KC_EQUAL,KC_AMPR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CLO_TAP, KC_4,    KC_5,   KC_6,   KC_DOT,  _______,
 ...
 */
    [_R_SHORT] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, G(KC_4), G(KC_5), G(KC_6), _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
